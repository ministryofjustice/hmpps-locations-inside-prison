...
context('Add To Certificate - Draft Cell Existing Landing - Details', () => {
  let page: UpdateSignedOpCapDetailsPage

  context('With MANAGE_RES_LOCATIONS_OP_CAP role', () => {
    beforeEach(() => {
      setupStubs(['MANAGE_RES_LOCATIONS_OP_CAP'])
      page = goToUpdateSignedOpCapDetails(draftCellLocationId)
    })
    ...
    it('displays the correct validation error when new op cap is higher than prison max cap', () => {
      page.submit({ opCap: 213, explanation: 'Dave told me to do it' })
    ...
    it('continues to submit when validation passes', () => {
      page.submit({ opCap: 210, explanation: 'Dave told me to do it' })
