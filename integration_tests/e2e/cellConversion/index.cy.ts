  ...
  context('with the MANAGE_RESIDENTIAL_LOCATIONS role', () => {
    ...
    describe('confirmation page', () => {
      context('when NORMAL_ACCOMMODATION and specific cell types', () => {
        ...
        it('can display Error validations previous selections after deselection when converting non-residential to residential cell', () => {
          ...
          const setCellConversionSetCellTypePage = Page.verifyOnPage(CellConversionSetCellTypePage)
          setCellConversionSetCellTypePage.cellTypeCheckboxItem('ACCESSIBLE_CELL').uncheck()
          setCellConversionSetCellTypePage.cellTypeCheckboxItem('BIOHAZARD_DIRTY_PROTEST').uncheck()
          setCellConversionSetCellTypePage.cellTypeCheckboxItem('CONSTANT_SUPERVISION').uncheck()
          Page.verifyOnPage(CellConversionSetCellTypePage)
          setCellConversionSetCellTypePage.continueButton().click()
          Page.verifyOnPage(CellConversionSetCellTypePage)
          setCellConversionSetCellTypePage.backLink().click()
          const specificCellTypePage = Page.verifyOnPage(CellConversionSpecificCellTypePage)
          specificCellTypePage.yesRadioButton().click()
          specificCellTypePage.backLink().click()
          const usedForPage = Page.verifyOnPage(CellConversionUsedForPage)
          usedForPage.usedForCheckboxItem('CLOSE_SUPERVISION_CENTRE').uncheck()
          usedForPage.usedForCheckboxItem('SUB_MISUSE_DRUG_RECOVERY').uncheck()
          usedForPage.usedForCheckboxItem('FIRST_NIGHT_CENTRE').uncheck()
          usedForPage.continueButton().click()
          Page.verifyOnPage(CellConversionUsedForPage)
        })
