  ...
  context('With the MANAGE_RESIDENTIAL_LOCATIONS role', () => {
    ...
    context('When location id is provided', () => {
      beforeEach(() => {
        ...
        LocationsApiStubber.stub.stubLocationsPrisonInactiveCells([location])
        ...
        LocationsApiStubber.stub.stubLocationsChangeTemporaryDeactivationDetails()
      ...
      describe('view location page', () => {
        it('does not display the success notification banner with the expected elements when a change is made in the details page', () => {
          Page.verifyOnPage(ChangeTemporaryDeactivationDetailsPage)
        ...
        it('displays the success notification banner with the expected elements when a change is made in the details page', () => {
          const detailsPage = Page.verifyOnPage(ChangeTemporaryDeactivationDetailsPage)
