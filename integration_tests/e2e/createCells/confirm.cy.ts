...
context('Create Landing - Create cells - Confirm', () => {
  ...
  context('With MANAGE_RES_LOCATIONS_OP_CAP role', () => {
    ...
    it('shows the correct information and successfully creates draft landing', () => {
      ...
      viewLocationsShowPage.successBannerHeading().contains('Cells created')
      viewLocationsShowPage.successBannerBody().contains('You have created 4 cells on landing A-2.')
    })
