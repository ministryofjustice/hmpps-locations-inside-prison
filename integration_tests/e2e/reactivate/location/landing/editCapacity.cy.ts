...
context('Certification Reactivation - Landing - Edit capacity', () => {
  ...
  it('displays the correct errors', () => {
    ...
    Page.checkForError('baselineCna-7e570000-0000-000a-0001-000000000011', 'Enter a baseline CNA', 'A-1-001: ')
    Page.checkForError('workingCapacity-7e570000-0000-000a-0001-000000000011', 'Enter a working capacity', 'A-1-001: ')
    Page.checkForError('maximumCapacity-7e570000-0000-000a-0001-000000000011', 'Enter a maximum capacity', 'A-1-001: ')

    // must be a number
    page.submit({ capacities: [['a', 'b', 'c']] })
    Page.checkForError('baselineCna-7e570000-0000-000a-0001-000000000011', 'Baseline CNA must be a number', 'A-1-001: ')
    Page.checkForError(
      'workingCapacity-7e570000-0000-000a-0001-000000000011',
      'Working capacity must be a number',
      'A-1-001: ',
    )
    Page.checkForError(
      'maximumCapacity-7e570000-0000-000a-0001-000000000011',
    ...
    Page.checkForError(
      'baselineCna-7e570000-0000-000a-0001-000000000011',
  ...
  it('displays the correct values for the cells, initially and when changing types and proceeds to check capacity and retains the updated values on submit', () => {
    ...
    checkCapacityPage.testCellsTable([
      ['A-1-001', '0', '0', '2', ['Biohazard / dirty protest cell']],
      ['A-1-002', '2', '2', '2', ['-']],
      ['A-1-003', '3', '3', '3', ['-']],
    ])
  })
