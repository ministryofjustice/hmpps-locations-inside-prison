...
context('Remove cell type', () => {
  ...
  context('with the MANAGE_RES_LOCATIONS_OP_CAP role', () => {
    ...
    context('when certificationApprovalRequired is INACTIVE', () => {
      ...
      context('when the working capacity is >= 1', () => {
        ...
        it('has the correct main heading and a caption showing the cell description', () => {
          ...
          cy.get('h1').contains('Are you sure you want to remove all of the cell types?')
        ...
        it('has the correct main heading when only one cell type', () => {
          ...
          cy.get('h1').contains('Are you sure you want to remove the cell type?')
        })
        ...
        it('shows the success banner when the change is complete', () => {
          ...
          cy.get('.govuk-notification-banner__content p').contains('You have removed the cell type for this location.')
        })
      })
      ...
      context('when the working capacity is zero', () => {
        ...
        describe('are you sure page', () => {
          ...
          it('shows the correct validation error when nothing is selected', () => {
            ...
            Page.checkForError('areYouSure', 'Select yes if you want to remove the cell types')
          })
          ...
          it('shows the correct validation error when nothing is selected and there is only one type', () => {
            ...
            cy.get('.govuk-error-summary__list').contains(/Select yes if you want to remove the cell type\s*$/)
            cy.get('#areYouSure-error').contains(/Select yes if you want to remove the cell type\s*$/)
          })
        ...
        describe('review cell capacity page', () => {
          ...
          it('has the correct inset text', () => {
            cy.get('.govuk-inset-text').contains(
              'Cells used as normal accommodation that are not a special cell type must have a working capacity of at least 1.',
            )
          })
          ...
          describe('validations', () => {
            ...
            it('shows the correct validation error when working capacity is zero for non-special cell', () => {
              const reviewCellCapacityPage = Page.verifyOnPage(ReviewCellCapacityPage)
              ...
              Page.checkForError('workingCapacity', 'Working capacity cannot be 0 for a non-special cell')
            })
    ...
    context('when certificationApprovalRequired is ACTIVE and location is DRAFT', () => {
      beforeEach(() => {
        cy.task('reset')
        cy.task('stubSignIn', { roles: ['MANAGE_RES_LOCATIONS_OP_CAP'] })
        cy.task('stubManageUsers')
      ...
      context('when the working capacity is zero', () => {
        ...
        describe('review cell capacity page', () => {
          ...
          it('has the correct warning text', () => {
            cy.get('.govuk-warning-text__text').contains('The cell’s CNA and working capacity must be more than 0.')
          })

          it('has the correct inset text', () => {
            cy.get('.govuk-inset-text').contains(
              'Cells used as normal accommodation that are not a special cell type must have a CNA and working capacity of at least 1.',
            )
          })
          ...
          describe('validations', () => {
            it('shows the correct validation error when missing working capacity', () => {
              ...
              reviewCellCapacityPage.maxCapacityInput().clear().type('4')
              reviewCellCapacityPage.workingCapacityInput().clear()
              reviewCellCapacityPage.updateButton().click()
