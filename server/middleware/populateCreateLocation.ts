...
import { LocationStatus, LocationType, Location } from '../data/types/locationsApi'

export default function populateCreateLocation() {
  return async (req: Request | FormWizard.Request, res: Response, next: NextFunction): Promise<void> => {
    ...
    try {
      ...
      location = {
        ...
        code: '',
        pathHierarchy: '',
        locationType: req.params.locationType.toUpperCase() as LocationType,
